...
ifeq ($(DEBUG), 0)
CFLAGS=-O3 -flto -mavx -march=native -Wall -Wno-unused-function -MMD -MP $(FTEST_MACROS)
CPPFLAGS=-O3 -flto -mavx -march=native -std=c++17 -Wall -Wno-unused-function -MMD -MP $(FTEST_MACROS)
else
