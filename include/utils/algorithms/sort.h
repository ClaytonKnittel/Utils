 ...
 * does t1 < t2
 */
#define __default_sort_cmp(t1, t2) ((t1) < (t2))
...
#define DEFINE_BINARY_INSERTION_FIND(T, name, __sort_cmp)                      \
  static inline size_t binary_insertion_find_##name(T* els, size_t N, T key) { \
    size_t l = 0;                                                              \
    size_t r = N - 1;                                                          \
                                                                               \
...
#define DEFINE_BINARY_INSERTION_SORT(T, name)                  \
  static void binary_insertion_sort_##name(T* els, size_t N) { \
    T el;                                                      \
    size_t loc;                                                \
    size_t j;                                                  \
                                                               \
...
#define DEFINE_LINEAR_INSERTION_SORT(T, name, __sort_cmp)      \
  static void linear_insertion_sort_##name(T* els, size_t N) { \
    T el;                                                      \
    size_t j;                                                  \
                                                               \
    for (size_t i = 1; i < N; i++) {                           \
...
#define DEFINE_QUICK_SORT_PARTITION(T, name, __sort_cmp)                        \
  static size_t quick_sort_partition_##name(T* els, size_t N, size_t pivot) {   \
    /*                                                                          \
    size_t l = 0;                                                               \
    size_t r = N - 1;                                                           \
    uint8_t do_l = 0;                                                           \
...
#define DEFINE_QUICK_SORT_RECURSIVE(T, name)                       \
  static void quick_sort_recursive_##name(T* els, size_t N) {      \
    if (N <= SMALL_SORT_MAX) {                                     \
...
#define DEFINE_QUICK_SORT(T, name)                  \
  static void quick_sort_##name(T* els, size_t N) { \
    quick_sort_recursive_##name(els, N);            \
  }

#define DEFINE_CSORT(T, name)                  \
  static void csort_##name(T* els, size_t N) { \
...
#define DEFINE_CSORT_DEFAULT_FNS_16(T)                        \
  DEFINE_COSRT_DEFAULT_FNS_NAMED_16(T, T, __default_sort_cmp, \
