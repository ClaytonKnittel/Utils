...
class sherwood_v3_table : private EntryAlloc, private Hasher, private Equal {
 ...
 private:
  ...
  long_t num_buckets_for_reserve(long_t num_elements) const {
    return static_cast<long_t>(std::ceil(
  ...
  void deallocate_data(EntryPointer begin, long_t num_slots_minus_one,
                       int8_t max_lookups) {
...
struct prime_number_hash_policy {
  static long_t mod0(long_t) {
    return 0llu;
  }
  static long_t mod2(long_t hash) {
    return hash % 2llu;
  }
  static long_t mod3(long_t hash) {
    return hash % 3llu;
  }
  static long_t mod5(long_t hash) {
    return hash % 5llu;
  }
  static long_t mod7(long_t hash) {
    return hash % 7llu;
  }
  static long_t mod11(long_t hash) {
    return hash % 11llu;
  }
  static long_t mod13(long_t hash) {
    return hash % 13llu;
  }
  static long_t mod17(long_t hash) {
    return hash % 17llu;
  }
  static long_t mod23(long_t hash) {
    return hash % 23llu;
  }
  static long_t mod29(long_t hash) {
    return hash % 29llu;
  }
  static long_t mod37(long_t hash) {
    return hash % 37llu;
  }
  static long_t mod47(long_t hash) {
    return hash % 47llu;
  }
  static long_t mod59(long_t hash) {
    return hash % 59llu;
  }
  static long_t mod73(long_t hash) {
    return hash % 73llu;
  }
  static long_t mod97(long_t hash) {
    return hash % 97llu;
  }
  static long_t mod127(long_t hash) {
    return hash % 127llu;
  }
  static long_t mod151(long_t hash) {
    return hash % 151llu;
  }
  static long_t mod197(long_t hash) {
    return hash % 197llu;
  }
  static long_t mod251(long_t hash) {
    return hash % 251llu;
  }
  static long_t mod313(long_t hash) {
    return hash % 313llu;
  }
  static long_t mod397(long_t hash) {
    return hash % 397llu;
  }
  static long_t mod499(long_t hash) {
    return hash % 499llu;
  }
  static long_t mod631(long_t hash) {
    return hash % 631llu;
  }
  static long_t mod797(long_t hash) {
    return hash % 797llu;
  }
  static long_t mod1009(long_t hash) {
    return hash % 1009llu;
  }
  static long_t mod1259(long_t hash) {
    return hash % 1259llu;
  }
  static long_t mod1597(long_t hash) {
    return hash % 1597llu;
  }
  static long_t mod2011(long_t hash) {
    return hash % 2011llu;
  }
  static long_t mod2539(long_t hash) {
    return hash % 2539llu;
  }
  static long_t mod3203(long_t hash) {
    return hash % 3203llu;
  }
  static long_t mod4027(long_t hash) {
    return hash % 4027llu;
  }
  static long_t mod5087(long_t hash) {
    return hash % 5087llu;
  }
  static long_t mod6421(long_t hash) {
    return hash % 6421llu;
  }
  static long_t mod8089(long_t hash) {
    return hash % 8089llu;
  }
  static long_t mod10193(long_t hash) {
    return hash % 10193llu;
  }
  static long_t mod12853(long_t hash) {
    return hash % 12853llu;
  }
  static long_t mod16193(long_t hash) {
    return hash % 16193llu;
  }
  static long_t mod20399(long_t hash) {
    return hash % 20399llu;
  }
  static long_t mod25717(long_t hash) {
    return hash % 25717llu;
  }
  static long_t mod32401(long_t hash) {
    return hash % 32401llu;
  }
  static long_t mod40823(long_t hash) {
    return hash % 40823llu;
  }
  static long_t mod51437(long_t hash) {
    return hash % 51437llu;
  }
  static long_t mod64811(long_t hash) {
    return hash % 64811llu;
  }
  static long_t mod81649(long_t hash) {
    return hash % 81649llu;
  }
  static long_t mod102877(long_t hash) {
    return hash % 102877llu;
  }
  static long_t mod129607(long_t hash) {
    return hash % 129607llu;
  }
  static long_t mod163307(long_t hash) {
    return hash % 163307llu;
  }
  static long_t mod205759(long_t hash) {
    return hash % 205759llu;
  }
  static long_t mod259229(long_t hash) {
    return hash % 259229llu;
  }
  static long_t mod326617(long_t hash) {
    return hash % 326617llu;
  }
  static long_t mod411527(long_t hash) {
    return hash % 411527llu;
  }
  static long_t mod518509(long_t hash) {
    return hash % 518509llu;
  }
  static long_t mod653267(long_t hash) {
    return hash % 653267llu;
  }
  static long_t mod823117(long_t hash) {
    return hash % 823117llu;
  }
  static long_t mod1037059(long_t hash) {
    return hash % 1037059llu;
  }
  static long_t mod1306601(long_t hash) {
    return hash % 1306601llu;
  }
  static long_t mod1646237(long_t hash) {
    return hash % 1646237llu;
  }
  static long_t mod2074129(long_t hash) {
    return hash % 2074129llu;
  }
  static long_t mod2613229(long_t hash) {
    return hash % 2613229llu;
  }
  static long_t mod3292489(long_t hash) {
    return hash % 3292489llu;
  }
  static long_t mod4148279(long_t hash) {
    return hash % 4148279llu;
  }
  static long_t mod5226491(long_t hash) {
    return hash % 5226491llu;
  }
  static long_t mod6584983(long_t hash) {
    return hash % 6584983llu;
  }
  static long_t mod8296553(long_t hash) {
    return hash % 8296553llu;
  }
  static long_t mod10453007(long_t hash) {
    return hash % 10453007llu;
  }
  static long_t mod13169977(long_t hash) {
    return hash % 13169977llu;
  }
  static long_t mod16593127(long_t hash) {
    return hash % 16593127llu;
  }
  static long_t mod20906033(long_t hash) {
    return hash % 20906033llu;
  }
  static long_t mod26339969(long_t hash) {
    return hash % 26339969llu;
  }
  static long_t mod33186281(long_t hash) {
    return hash % 33186281llu;
  }
  static long_t mod41812097(long_t hash) {
    return hash % 41812097llu;
  }
  static long_t mod52679969(long_t hash) {
    return hash % 52679969llu;
  }
  static long_t mod66372617(long_t hash) {
    return hash % 66372617llu;
  }
  static long_t mod83624237(long_t hash) {
    return hash % 83624237llu;
  }
  static long_t mod105359939(long_t hash) {
    return hash % 105359939llu;
  }
  static long_t mod132745199(long_t hash) {
    return hash % 132745199llu;
  }
  static long_t mod167248483(long_t hash) {
    return hash % 167248483llu;
  }
  static long_t mod210719881(long_t hash) {
    return hash % 210719881llu;
  }
  static long_t mod265490441(long_t hash) {
    return hash % 265490441llu;
  }
  static long_t mod334496971(long_t hash) {
    return hash % 334496971llu;
  }
  static long_t mod421439783(long_t hash) {
    return hash % 421439783llu;
  }
  static long_t mod530980861(long_t hash) {
    return hash % 530980861llu;
  }
  static long_t mod668993977(long_t hash) {
    return hash % 668993977llu;
  }
  static long_t mod842879579(long_t hash) {
    return hash % 842879579llu;
  }
  static long_t mod1061961721(long_t hash) {
    return hash % 1061961721llu;
  }
  static long_t mod1337987929(long_t hash) {
    return hash % 1337987929llu;
  }
  static long_t mod1685759167(long_t hash) {
    return hash % 1685759167llu;
  }
  static long_t mod2123923447(long_t hash) {
    return hash % 2123923447llu;
  }
  static long_t mod2675975881(long_t hash) {
    return hash % 2675975881llu;
  }
  static long_t mod3371518343(long_t hash) {
    return hash % 3371518343llu;
  }
  static long_t mod4247846927(long_t hash) {
    return hash % 4247846927llu;
  }
  static long_t mod5351951779(long_t hash) {
    return hash % 5351951779llu;
  }
  static long_t mod6743036717(long_t hash) {
    return hash % 6743036717llu;
  }
  static long_t mod8495693897(long_t hash) {
    return hash % 8495693897llu;
  }
  static long_t mod10703903591(long_t hash) {
    return hash % 10703903591llu;
  }
  static long_t mod13486073473(long_t hash) {
    return hash % 13486073473llu;
  }
  static long_t mod16991387857(long_t hash) {
    return hash % 16991387857llu;
  }
  static long_t mod21407807219(long_t hash) {
    return hash % 21407807219llu;
  }
  static long_t mod26972146961(long_t hash) {
    return hash % 26972146961llu;
  }
  static long_t mod33982775741(long_t hash) {
    return hash % 33982775741llu;
  }
  static long_t mod42815614441(long_t hash) {
    return hash % 42815614441llu;
  }
  static long_t mod53944293929(long_t hash) {
    return hash % 53944293929llu;
  }
  static long_t mod67965551447(long_t hash) {
    return hash % 67965551447llu;
  }
  static long_t mod85631228929(long_t hash) {
    return hash % 85631228929llu;
  }
  static long_t mod107888587883(long_t hash) {
    return hash % 107888587883llu;
  }
  static long_t mod135931102921(long_t hash) {
    return hash % 135931102921llu;
  }
  static long_t mod171262457903(long_t hash) {
    return hash % 171262457903llu;
  }
  static long_t mod215777175787(long_t hash) {
    return hash % 215777175787llu;
  }
  static long_t mod271862205833(long_t hash) {
    return hash % 271862205833llu;
  }
  static long_t mod342524915839(long_t hash) {
    return hash % 342524915839llu;
  }
  static long_t mod431554351609(long_t hash) {
    return hash % 431554351609llu;
  }
  static long_t mod543724411781(long_t hash) {
    return hash % 543724411781llu;
  }
  static long_t mod685049831731(long_t hash) {
    return hash % 685049831731llu;
  }
  static long_t mod863108703229(long_t hash) {
    return hash % 863108703229llu;
  }
  static long_t mod1087448823553(long_t hash) {
    return hash % 1087448823553llu;
  }
  static long_t mod1370099663459(long_t hash) {
    return hash % 1370099663459llu;
  }
  static long_t mod1726217406467(long_t hash) {
    return hash % 1726217406467llu;
  }
  static long_t mod2174897647073(long_t hash) {
    return hash % 2174897647073llu;
  }
  static long_t mod2740199326961(long_t hash) {
    return hash % 2740199326961llu;
  }
  static long_t mod3452434812973(long_t hash) {
    return hash % 3452434812973llu;
  }
  static long_t mod4349795294267(long_t hash) {
    return hash % 4349795294267llu;
  }
  static long_t mod5480398654009(long_t hash) {
    return hash % 5480398654009llu;
  }
  static long_t mod6904869625999(long_t hash) {
    return hash % 6904869625999llu;
  }
  static long_t mod8699590588571(long_t hash) {
    return hash % 8699590588571llu;
  }
  static long_t mod10960797308051(long_t hash) {
    return hash % 10960797308051llu;
  }
  static long_t mod13809739252051(long_t hash) {
    return hash % 13809739252051llu;
  }
  static long_t mod17399181177241(long_t hash) {
    return hash % 17399181177241llu;
  }
  static long_t mod21921594616111(long_t hash) {
    return hash % 21921594616111llu;
  }
  static long_t mod27619478504183(long_t hash) {
    return hash % 27619478504183llu;
  }
  static long_t mod34798362354533(long_t hash) {
    return hash % 34798362354533llu;
  }
  static long_t mod43843189232363(long_t hash) {
    return hash % 43843189232363llu;
  }
  static long_t mod55238957008387(long_t hash) {
    return hash % 55238957008387llu;
  }
  static long_t mod69596724709081(long_t hash) {
    return hash % 69596724709081llu;
  }
  static long_t mod87686378464759(long_t hash) {
    return hash % 87686378464759llu;
  }
  static long_t mod110477914016779(long_t hash) {
    return hash % 110477914016779llu;
  }
  static long_t mod139193449418173(long_t hash) {
    return hash % 139193449418173llu;
  }
  static long_t mod175372756929481(long_t hash) {
    return hash % 175372756929481llu;
  }
  static long_t mod220955828033581(long_t hash) {
    return hash % 220955828033581llu;
  }
  static long_t mod278386898836457(long_t hash) {
    return hash % 278386898836457llu;
  }
  static long_t mod350745513859007(long_t hash) {
    return hash % 350745513859007llu;
  }
  static long_t mod441911656067171(long_t hash) {
    return hash % 441911656067171llu;
  }
  static long_t mod556773797672909(long_t hash) {
    return hash % 556773797672909llu;
  }
  static long_t mod701491027718027(long_t hash) {
    return hash % 701491027718027llu;
  }
  static long_t mod883823312134381(long_t hash) {
    return hash % 883823312134381llu;
  }
  static long_t mod1113547595345903(long_t hash) {
    return hash % 1113547595345903llu;
  }
  static long_t mod1402982055436147(long_t hash) {
    return hash % 1402982055436147llu;
  }
  static long_t mod1767646624268779(long_t hash) {
    return hash % 1767646624268779llu;
  }
  static long_t mod2227095190691797(long_t hash) {
    return hash % 2227095190691797llu;
  }
  static long_t mod2805964110872297(long_t hash) {
    return hash % 2805964110872297llu;
  }
  static long_t mod3535293248537579(long_t hash) {
    return hash % 3535293248537579llu;
  }
  static long_t mod4454190381383713(long_t hash) {
    return hash % 4454190381383713llu;
  }
  static long_t mod5611928221744609(long_t hash) {
    return hash % 5611928221744609llu;
  }
  static long_t mod7070586497075177(long_t hash) {
    return hash % 7070586497075177llu;
  }
  static long_t mod8908380762767489(long_t hash) {
    return hash % 8908380762767489llu;
  }
  static long_t mod11223856443489329(long_t hash) {
    return hash % 11223856443489329llu;
  }
  static long_t mod14141172994150357(long_t hash) {
    return hash % 14141172994150357llu;
  }
  static long_t mod17816761525534927(long_t hash) {
    return hash % 17816761525534927llu;
  }
  static long_t mod22447712886978529(long_t hash) {
    return hash % 22447712886978529llu;
  }
  static long_t mod28282345988300791(long_t hash) {
    return hash % 28282345988300791llu;
  }
  static long_t mod35633523051069991(long_t hash) {
    return hash % 35633523051069991llu;
  }
  static long_t mod44895425773957261(long_t hash) {
    return hash % 44895425773957261llu;
  }
  static long_t mod56564691976601587(long_t hash) {
    return hash % 56564691976601587llu;
  }
  static long_t mod71267046102139967(long_t hash) {
    return hash % 71267046102139967llu;
  }
  static long_t mod89790851547914507(long_t hash) {
    return hash % 89790851547914507llu;
  }
  static long_t mod113129383953203213(long_t hash) {
    return hash % 113129383953203213llu;
  }
  static long_t mod142534092204280003(long_t hash) {
    return hash % 142534092204280003llu;
  }
  static long_t mod179581703095829107(long_t hash) {
    return hash % 179581703095829107llu;
  }
  static long_t mod226258767906406483(long_t hash) {
    return hash % 226258767906406483llu;
  }
  static long_t mod285068184408560057(long_t hash) {
    return hash % 285068184408560057llu;
  }
  static long_t mod359163406191658253(long_t hash) {
    return hash % 359163406191658253llu;
  }
  static long_t mod452517535812813007(long_t hash) {
    return hash % 452517535812813007llu;
  }
  static long_t mod570136368817120201(long_t hash) {
    return hash % 570136368817120201llu;
  }
  static long_t mod718326812383316683(long_t hash) {
    return hash % 718326812383316683llu;
  }
  static long_t mod905035071625626043(long_t hash) {
    return hash % 905035071625626043llu;
  }
  static long_t mod1140272737634240411(long_t hash) {
    return hash % 1140272737634240411llu;
  }
  static long_t mod1436653624766633509(long_t hash) {
    return hash % 1436653624766633509llu;
  }
  static long_t mod1810070143251252131(long_t hash) {
    return hash % 1810070143251252131llu;
  }
  static long_t mod2280545475268481167(long_t hash) {
    return hash % 2280545475268481167llu;
  }
  static long_t mod2873307249533267101(long_t hash) {
    return hash % 2873307249533267101llu;
  }
  static long_t mod3620140286502504283(long_t hash) {
    return hash % 3620140286502504283llu;
  }
  static long_t mod4561090950536962147(long_t hash) {
    return hash % 4561090950536962147llu;
  }
  static long_t mod5746614499066534157(long_t hash) {
    return hash % 5746614499066534157llu;
  }
  static long_t mod7240280573005008577(long_t hash) {
    return hash % 7240280573005008577llu;
  }
  static long_t mod9122181901073924329(long_t hash) {
    return hash % 9122181901073924329llu;
  }
  static long_t mod11493228998133068689(long_t hash) {
    return hash % 11493228998133068689llu;
  }
  static long_t mod14480561146010017169(long_t hash) {
    return hash % 14480561146010017169llu;
  }
  static long_t mod18446744073709551557(long_t hash) {
  ...
  mod_function next_size_over(long_t &size) const {
    ...
    static constexpr const long_t prime_list[] = {2llu,
                                                  3llu,
                                                  5llu,
                                                  7llu,
                                                  11llu,
    ...
    const long_t *found = std::lower_bound(std::begin(prime_list),
...
class flat_hash_set
    : public detailv3::sherwood_v3_table<
          T, T, H, detailv3::functor_storage<long_t, H>, E,
