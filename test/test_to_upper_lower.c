...
void calc_avg_times_upper(uint64_t len, uint32_t n_trials, double* naive_s,
  ...
  for (i = 0; i < n_trials / 2; i++) {
    ...
    total_ns_1 += (end1.tv_nsec - start1.tv_nsec) +
                  (end1.tv_sec - start1.tv_sec) * 1000000000;
    total_ns_2 += (end2.tv_nsec - start2.tv_nsec) +
                  (end2.tv_sec - start2.tv_sec) * 1000000000;

    // printf("naive took %f secs\n", (end1.tv_nsec - start1.tv_nsec) /
    // 1000000000. + (end1.tv_sec - start1.tv_sec)); printf("mine took  %f
    // secs\n", (end2.tv_nsec - start2.tv_nsec) / 1000000000. + (end2.tv_sec -
    // start2.tv_sec));
  ...
  for (; i < n_trials; i++) {
    ...
    // 1000000000. + (end2.tv_sec - start2.tv_sec)); printf("naive took %f
    // secs\n", (end1.tv_nsec - start1.tv_nsec) / 1000000000. + (end1.tv_sec -
    // start1.tv_sec));
